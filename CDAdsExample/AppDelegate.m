...
#define CDAdsKey                      @"gravysdkkey"
#define CDAdsSecret                   @"gravysdksecretkey"
...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    params.appKey = @"midnightrambler";
    params.secretKey = @"drawlswiftbayonet";
    params.host = @"https://gw.pinable.jp";
